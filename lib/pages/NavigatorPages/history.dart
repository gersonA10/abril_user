                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Row(
                                                              ...
                                                              children: [
                                                               MyText(
                                                                ...
                                                                MyText(
                                                                    text: (myHistory[i]['later_ride'] == true)
                                                                        ? myHistory[i]['trip_start_time']
                                                                        : (myHistory[i]['cancelled_ride'] == true)
                                                                            ? myHistory[i][ 'converted_cancelled_at']
                                                                            : (myHistory[i]['completed_ride'] == true)
                                                                            ? intl.DateFormat("d 'de' MMMM - hh:mm a", "es_ES").format(intl.DateFormat("d'th' MMM hh:mm a").parse(myHistory[i]['converted_completed_at'] .toString(),))
                                                                                // ? myHistory[i]['converted_completed_at'] .toString()
                                                                                : myHistory[i]['converted_created_at'].toString(),
                                                                    color:
                                                                        hintColor,
                                                                    fontweight:
                                                                        FontWeight
                                                            ...
                                                            Row(
                                                              children: [
                                                                Container(
                                                                  width: (myHistory[i][ 'drop_address'] !=null) ? media.width * 0.76 : media.width * 0.8,
                                                            ...
                                                            Container(
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        myHistory[i]['driverDetail'] == null ? Text('Viaje Cancelado')
