...
import 'package:flutter_user/functions/providers/cancel_request_provider.dart';
...
import 'package:flutter_user/widgets/bottom_sheet_cancel.dart';
...
// import '../chatPage1/chat_page.dart';
...
List<fmlt.LatLng> dibujadoDriverUser = [];
// bool mostrarDibujadoDriverUser = false;
// dynamic chooseLuggages;
// dynamic choosePets;
...
class _BookingConfirmationState extends State<BookingConfirmation>
  ...
  bool viajeAceptado = false;
  bool isAccept = false;
  bool dibujar = false;
  bool rutaDibujada = false; // Nueva variable para evitar redibujado
  ...
  await _driverLocationSubscription?.cancel();
    ...
    DatabaseReference driverRef = FirebaseDatabase.instance.ref('drivers/driver_$driverId');
    _driverLocationSubscription = driverRef.onValue.listen((event) {
      ...
      if (event.snapshot.value != null) {
        ...
        List<dynamic> location = data['l'] as List<dynamic>? ?? [0.0, 0.0];
        double lat = location[0] ?? 0.0;
        double lng = location[1] ?? 0.0;

        if (mounted) {
          setState(() {
            driverPosition = fmlt.LatLng(lat, lng);
          });

          if (_isCameraFollowing) {
            _fmController.move(driverPosition!, _fmController.camera.zoom);
          }
        }
      }
      } catch (e) {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (userRequestData['id'] != null) {
        requestID = userRequestData['id'];
      }
    });
    fmpoly.clear();
    dibujadoDriverUser.clear();
...
//get location permission and location details
  ...
  void startListeningToRequestStreams(String requestID) {
    // Escucha el stream para contar los mensajes
    _messageCountSubscription =
        requestService.getMessageCountStream(requestID).listen((request) {
        ...
        if (request != null && request > previousMessageCount) {
          for (int i = previousMessageCount; i < request; i++) {
            if (isAlertShowing == false) {
              showAlertAndPlaySound(context, requestID);
            }
          }
        }
    ...
    _statusRideSubscription =
        requestService.getStatusRide(requestID).listen((request) {
      if (request == 1) {
    ...
    _cancelledByUserSubscription =
        requestService.getCancelledByUser(requestID).listen((request) {
      if (request == "1") {
        setState(() {
                ...
                builder: (context, value, child) {
                  ...
                  return StreamBuilder<DatabaseEvent>(
                      ...
                      builder: (context, AsyncSnapshot<DatabaseEvent> event) {
                        ...
                        return StreamBuilder<DatabaseEvent>(
                              stream: (userRequestData['driverDetail'] != null && pinLocationIcon != null)
      ? FirebaseDatabase.instance
          .ref('drivers/driver_${userRequestData['driverDetail']['data']['id']}')
          .onValue
      : null,
                            builder:
                              ...
                              if (event.hasData &&
                                ...
                                var snapshots = event.data!.snapshot;
                                var driverData =
                                    jsonDecode(jsonEncode(snapshots.value));

                                List location = driverData['l'] ?? [0.0, 0.0];
                                ...
                                WidgetsBinding.instance
                                  ...
                                  if (mounted) {
                                    ...
                                    if (_isCameraFollowing) {
                                      _fmController.move(driverPosition!,
                              ...
                              return Stack(
                                ...
                                children: [
                                              ...
                                              builder: (context, snapshot) {
                                                return fm.FlutterMap(
                                                  ...
                                                  children: [
                                                    ...
                                                    // if(userRequestData['arrived_at'] == null && userRequestData['is_trip_start'] == 0)
                                                    // if(mostrardDibujadoDestino == true)
                                                    //   fm.PolylineLayer(
                                                    //     polylines: [
                                                    //       fm.Polyline(
                                                    //           points: dibujadoDriverUser,
                                                    //           color: theme,
                                                    //           strokeWidth: 4,
                                                    //     ),
                                                    //     ],
                                                      ...
                                                      markers: [
                                                                      ...
                                                                      ? Column(
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              height: (platform == TargetPlatform.android) ? media.width * 0.12 : media.width * 0.15,
                                                                              width: (platform == TargetPlatform.android) ? media.width * 0.12 : media.width * 0.15,
                                                                            ),
                                                                          ],
                                                                        )
                                                                      : MyText(
                                                        ...
                                                        fm.Marker(
                                                          ...
                                                          point: driverPosition ??
                                                              const fmlt.LatLng(
                                                                  -21.5355,
                                                                  -64.7296), // Fallback si no hay datos
                                                          width: 50,
                                                          height: 50,
                                                          child: Image.asset( 'assets/images/top-taxi.png'),
                                                        ),
                                                                                                        ...
                                                                                                        child: Column(
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Stack(
                                                                                                              ...
                                                                                                              children: [
                                                                                                                SizedBox(
                                                                                                                  height: media.height * (!(choosenVehicle != i) ? 0.17 : 0.15),
                                                                                                                  width: media.width * (!(choosenVehicle != i) ? 0.29 : 0.27),
                                                                                                                  child: Container(
                                                                                                                    ...
                                                                                                                    decoration: BoxDecoration(
                                                                                                                      ...
                                                                                                                      boxShadow: const [
                                                                                                                        BoxShadow(color: Color.fromARGB(255, 192, 192, 192), blurRadius: 3.0, spreadRadius: 1, offset: Offset(0.0, 4.0))
                                                                                                                      ],
                                                                                                                      gradient: (choosenVehicle != i)
                                                                                                                          ? const LinearGradient(
                                                                                                                              begin: Alignment.centerLeft, // Inicio del degradado
                                                                                                                      ...
                                                                                                                      children: [
                                                                                                                        if (widget.type != 2)
                                                                                                                          (etaDetails[i]['has_discount'] != true || etaDetails[i]['enable_bidding'] == true)
                                                                                                                              ? (isOneWayTrip)
                                                                                                                                  ? ((etaDetails[i]['total']) != 0)
                                                                                                                                      ? Row(
                                                                                                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                                                                                                          children: [
                                                                                                                                            Text(
                                                                                                                                              "${etaDetails[i]['currency']} ${NumberFormat.currency(
                                                                                                                                                locale: 'es_BO', // Localización para Bolivia (opcional)
                                                                                                                                                symbol: '', // Símbolo de la moneda
                                                                                                                                                decimalDigits: 1,
                                                                                                                                              ).format(double.tryParse(etaDetails[i]['total'].toString()) ?? 0)}"
                                                                                                                                        ...
                                                                                                                                        Column(
                                                                                                                                          children: [
                                                                                                                                            Text(
                                                                                                                                              ...
                                                                                                                                              style: GoogleFonts.notoSans(fontSize: media.width * fourteen, color: textColorwhite, fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough),
                                                                                                                                            ),
                                                                                                                                            Text(
                                                                                                                                              etaDetails[i]['discounted_totel'].toString(),
                                                                                                                                              style: GoogleFonts.notoSans(fontSize: media.width * fourteen, color: textColorwhite, fontWeight: FontWeight.w700),
                                                                                                                                            )
                                                                                                                                          ],
                                                                                                                                        ),
                                                                                                                                      ],
                                                                                                                        ...
                                                                                                                        Row(
                                                                                                                          children: [
                                                                                                                            Padding(
                                                                                                                              ...
                                                                                                                              child: Icon(
                                                                                                                                (etaDetails[i]['transport_type'] == 'delivery') ? CupertinoIcons.bag : Icons.person_outline,
                                                                                                                                color: textColorwhite,
                                                                                                                                size: 20,
                                                                                                                              ),
                                                                                                                            ),
                                                                                                                        ...
                                                                                                                        Row(children: [
                                                                                                                          ...
                                                                                                                          (minutes[etaDetails[i]['type_id']] != null && minutes[etaDetails[i]['type_id']] != '')
                                                                                                                              ? Text(
                                                                                                                                  ...
                                                                                                                                  style: GoogleFonts.notoSans(fontSize: 13, color: textColorwhite),
                                                                                                                                )
                                                                                                                              : Text(
                                                                                                                                  '--',
                                                                                                                                  style: GoogleFonts.notoSans(fontSize: 13, color: textColorwhite),
                                                                                                                ...
                                                                                                                SizedBox(
                                                                                                                  width: media.width * (!(choosenVehicle != i) ? 0.25 : 0.22),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                            ...
                                                                            children: [
                                                                              (choosenVehicle != null && widget.type != 1)
                                                                                  ? InkWell(
                                                                                      ...
                                                                                      child: Container(
                                                                                        decoration: BoxDecoration(color: page, borderRadius: BorderRadius.circular(15), boxShadow: kElevationToShadow[1]),
                                                                                        width: media.width * 0.3,
                                                                                        height: 35,
                                                                                        child: Row(
                                                                                          children: [
                                                                                            ...
                                                                                            MyText(
                                                                                              ...
                                                                                              size: 16,
                                                                                              fontweight: FontWeight.w600,
                                                                                              color: (isDarkTheme == true) ? Colors.white : hintColor,
                                                                                            ),
                                                                                          ],
                                                                                        ),
                                                                                      ),
                                                                              ...
                                                                              // //*ACA ES LAS PREFERENCIAS ANTERIORES
                                                                              // if ((!((userDetails['enable_driver_preference_for_user'] != '1' && userDetails['enable_pet_preference_for_user'] != '1' && userDetails['enable_luggage_preference_for_user'] != '1') || choosenTransportType == 1 || userDetails['enable_modules_for_applications'] == 'delivery')))
                                                                              //   InkWell(
                                                                              //     onTap: () {
                                                                              //       if (choosePets == true) {
                                                                              //         choosePets = true;
                                                                              ...
                                                                              //           // if (choosePets == true || chooseLuggages == true)
                                                                              //           //   MyText(
                                                                              //           //     text: ' :- ',
                                                                              //           //     size: media.width * fourteen,
                                                                              //           //     fontweight: FontWeight.w600,
                                                                              ...
                                                                              //           //   width: media.width * 0.025,
                                                                              //           // ),
                                                                              //           // (choosePets == false && chooseLuggages == false)
                                                                              //           //     ? Container()
                                                                              //           //     : Icon(
                                                                              //           //         // Icons.arrow_forward_ios,
                                                                              //           //         Icons.edit,
                                                                              ...
                                                                              if (choosenVehicle != null && (widget.type == 1 || etaDetails[choosenVehicle]['enable_bidding'] == null || etaDetails[choosenVehicle]['enable_bidding'] == false) && widget.type != 2 && isOneWayTrip == true)
                                                                                InkWell(
                                                                                  onTap: () {
                                                                                    // setState(() {
                                                                                    //   addCoupon =
                                                                        ...
                                                                        (choosenTransportType ==
                                                                            ...
                                                                            ? Column(
                                                                                children: [
                                                                                  Align(alignment: Alignment.centerLeft, child: MyText(text: "Datos", size: 14, fontweight: FontWeight.w600, color: theme)),
                                                                                  InkWell(
                                                                                    onTap: () {
                                                                                              ...
                                                                                              Column(
                                                                                                children: [
                                                                                                  SizedBox(
                                                                                                    width: media.width * 0.8,
                                                                                                    child: Text(
                                                                                                      "Nombre: ${addressList[0].name}",
                                                                                                      style: GoogleFonts.notoSans(fontSize: media.width * twelve, color: textColorGrey, fontWeight: FontWeight.w600),
                                                                                                      maxLines: 1,
                                                                                                  ...
                                                                                                  SizedBox(
                                                                                                    ...
                                                                                                    child: Row(
                                                                                                      ...
                                                                                                      children: [
                                                                                                        Text(
                                                                                                          "Número tel: ${addressList[0].number}",
                                                                                                          style: GoogleFonts.notoSans(fontSize: media.width * twelve, color: textColorGrey, fontWeight: FontWeight.w600),
                                                                                                          textAlign: TextAlign.end,
                                                                                                          maxLines: 1,
                                                                                                          overflow: TextOverflow.ellipsis,
                                                                                  ...
                                                                                  children: [
                                                                                    SizedBox(
                                                                                      ...
                                                                                      child: Text(
                                                                                        ...
                                                                                        style: GoogleFonts.notoSans(color: textColorGrey, fontSize: 14, fontWeight: FontWeight.w600),
                                                                                        maxLines: 1,
                                                                                        overflow: TextOverflow.ellipsis,
                                                                                      ),
                                                                                    ),
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Button(
                                                                                      ...
                                                                                      onTap: () async {
                                                                                        ...
                                                                                        final String? requestID = userRequestData['id']; // Asumiendo que obtienes el requestID aquí

                                                                                        if (requestID != null) {
                                                                                          setState(() {
                                                                                            hasRequestID = true; // Marca que ya tienes el requestID
                                                                                            currentRequestID = requestID; // Guarda el requestID
                                                                                          });

                                                                                          // Ahora que tienes el requestID, puedes empezar a escuchar los streams
                                                                                          startListeningToRequestStreams(requestID);
                                                                                        }
                                                                                      },
                                  ...
                                  //ACA EN LUGAR DE USAR ESTO ESTO TIENE QUE SER CON FIREBASE getStatusRide
                                  (userRequestData.isNotEmpty &&
                                          userRequestData['accepted_at'] !=
                                              null)
                                      ? AnimatedPositioned(
                                                                  ...
                                                                  ? Container(
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          ...
                                                                          color: Colors
                                                                              .grey
                                                                              .withOpacity(0.2)),
                                                                      child: (userRequestData['is_trip_start'] != 1 &&
                                                                    ...
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        userRequestData['driverDetail'] ==
                                                                                null
                                                                            ? ''
                                                                            : ' ${userRequestData['driverDetail']['data']['licencia']}',
                                                                        style: GoogleFonts.montserrat(
                                                                            height:
                                                                                0,
                                                                            fontWeight:
                                                                    ...
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        userRequestData['driverDetail'] ==
                                                                                null
                                                                            ? ''
                                                                            : ' ${userRequestData['driverDetail']['data']['placa']}',
                                                                        style: GoogleFonts.montserrat(
                                                                            height:
                                                                                0,
                                                                            fontWeight:
                                                                      ...
                                                                      Navigator
                                                                        ...
                                                                        MaterialPageRoute(
                                                                          builder: (context) =>
                                                                              ImageViewScreen(
                                                                            imageUrl:
                                                                                '${userRequestData['driverDetail']['data']['foto_vehiculo']}',
                                                                          ),
                                                                        ),
                                                                      );
                                                                    },
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        Navigator
                                                                          ...
                                                                          MaterialPageRoute(
                                                                            builder: (context) =>
                                                                                ImageViewScreen(
                                                                              imageUrl: userRequestData['driverDetail']['data']['profile_picture'],
                                                                            ),
                                                                          ),
                                                                        );
                                                                      },
                                                                      child: userRequestData['driverDetail'] ==
                                                                              null
                                                                          ? Container()
                                                                          : Container(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          MyText(
                                                                            text: userRequestData['driverDetail'] == null
                                                                                ? ''
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Expanded(
                                                                                child: MyText(
                                                                                  ...
                                                                                  text: userRequestData['driverDetail'] == null
                                                                                      ? ''
                                                                                      : (userRequestData['driverDetail']['data']['rating'] == 0)
                                                                        ...
                                                                        children: [
                                                                          InkWell(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Container(padding: const EdgeInsets.all(5), decoration: const BoxDecoration(shape: BoxShape.circle, color: Color(0xff484848)), width: media.width * 0.14, child: Image.asset('assets/images/chat-alt.png')),
                                                        ...
                                                        child:
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              //                                     decoration: BoxDecoration(color: page, borderRadius: BorderRadius.circular(10), boxShadow: kElevationToShadow[1]),
                                                              //                                     child: Row(
                                                              //                                       mainAxisAlignment: MainAxisAlignment.start,
                                                              //                                       // crossAxisAlignment: CrossAxisAlignment.start,
                                                              //                                       children: [
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            SizedBox(
                                                                              ...
                                                                              child: Text(
                                                                                ...
                                                                                style: GoogleFonts.notoSans(fontSize: 14, fontWeight: FontWeight.w600, color: buttonColor),
                                                                                textAlign: TextAlign.center,
                                                                                maxLines: 2,
                                                                                overflow: TextOverflow.ellipsis,
                                                                              ),
                                                                            ...
                                                                            (userRequestData['is_trip_start'] != 1)
                                                                                ? InkWell(
                                                                                    onTap: () async {
                                                                                      ...
                                                                                      var reason = await cancelReasons((userRequestData['is_driver_arrived'] == 0) ? 'before' : 'after');
                                                                                      if (reason == true) {
                                                                                        setState(() {
                                                                                          _cancellingError = '';
                                                                                          _cancelReason = '';
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            shape:
                                                                                BoxShape.circle,
                                                                            border: Border.all(color: theme, width: 1.2)),
                                                                        alignment:
                                                                            Alignment.center,
                                                                        child: (_cancelReason ==
                                                                    ...
                                                                    (sosData.isNotEmpty)
                                                                        ...
                                                                        : Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: GoogleFonts.notoSans(fontSize: media.width * eighteen, fontWeight: FontWeight.w600, color: textColor),
                                                                            ),
                                                                          ),
                                                                  ],
                                                                )),
