...
import 'package:flutter_user/pages/trip%20screen/choosegoods.dart';
      ...
      child: Column(
        ...
        children: [
          Image.network(
            (type != 1)
                ? etaDetails[i]['icon']
                : etaDetails[i]['typesWithPrice']['data'][0]['icon'],
            width: width * 0.4,
          ),
          SizedBox(
            height: width * 0.02,
          ...
          MyText(
            text: etaDetails[i]['short_description'],
            size: width * fourteen,
            fontweight: FontWeight.w600,
            color: hintColor,
          ),
                  ...
                  child: Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          MyText(text: 'Tarifa', size: width * fourteen),
                      ...
                      FareBreakupDetails(
                          width: width,
                          heading: 'Precio x Tiempo',
                          value: (type != 1)
                              ? '${etaDetails[i]['currency']} ${etaDetails[i]['price_per_time']} / min'
                              : '${etaDetails[i]['currency']} ${etaDetails[i]['typesWithPrice']['data'][0]['time_price_per_min'].toString()} / min'),
                      SizedBox(
                        height: width * 0.02,
                      ),
                      FareBreakupDetails(
                          width: width,
                          heading: 'Precio x Distancia',
                          value: (type != 1)
                              ? '${etaDetails[i]['currency']} ${etaDetails[i]['price_per_distance']} / ${etaDetails[i]['unit_in_words']}'
                              : '${etaDetails[i]['currency']} ${etaDetails[i]['typesWithPrice']['data'][0]['distance_price_per_km'].toString()} / ${etaDetails[i]['typesWithPrice']['data'][0]['unit_in_words']}'),
                      SizedBox(
                        height: width * 0.02,
                      ),
                      FareBreakupDetails(
                          ...
                          value: (type != 1)
                              ...
                              : etaDetails[i]['typesWithPrice']['data'][0]
                                      ['payment_type']
                                  .toString()),
                    ],
                  ),
