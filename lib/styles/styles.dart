...
Color textColorGrey = const Color(0xffB3B3B3);
...
Color inputFillColorGrey = const Color(0xffB3B3B3);
...
Color buttonColor = const Color(0xffBD121A);
Color startColor = const Color(0xffFDE24A);
// Color theme = const Color(0xffBD121A);
Color theme = Color.fromRGBO(212, 16, 22, 1);
Color buttonText = const Color(0xffFFFFFF);
Color buttonColorWhite = const Color(0xffFFFFFF);
Color inputFieldSeparator = const Color(0xff1DA1F2);
Color termsCheckBox = const Color(0xff39BF4E);
Color loaderColor = const Color(0xffBD121A);
...
Color starColor = const Color(0xffFDE24A);
